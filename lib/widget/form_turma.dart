...
class _FormTurmaState extends State<FormTurma> {
  ...
  void _loadData() async {
    final salasBanco = await daoSala.buscarTodos();
    setState(() {
      _salas = salasBanco;
    });
  }
  ...
  void _preencherCampos(DTOTurma turma) {
    ...
    _duracao =
        turma.duracaoMinutos > 0 ? turma.duracaoMinutos.toString() : null;
